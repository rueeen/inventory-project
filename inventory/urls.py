...
urlpatterns = [
    ...
    path("equipos/<int:pk>/editar/",
         EquipmentUpdateView.as_view(), name="equipment_update"),
    path("equipos/<int:pk>/eliminar/",
         EquipmentDeleteView.as_view(), name="equipment_delete"),
    path("equipos/importar/", EquipmentImportView.as_view(),
         name="equipment_import"),

    path("insumos/", SupplyListView.as_view(), name="supply_list"),
    path("insumos/nuevo/", SupplyCreateView.as_view(), name="supply_create"),
    path("insumos/<int:pk>/editar/",
         SupplyUpdateView.as_view(), name="supply_update"),
    path("insumos/<int:pk>/eliminar/",
         SupplyDeleteView.as_view(), name="supply_delete"),
    ...
    path("api/equipos/buscar/", equipment_search_api,
         name="equipment_search_api"),
